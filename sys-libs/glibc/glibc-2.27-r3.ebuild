...
IUSE="static static-nss audit caps compile-locales doc gd hardened headers-only multilib nscd profile selinux suid systemtap vanilla"
...
src_configure(){
	econf $(use_enable static ) $(use_enable static-nss ) --sysconfdir=/etc
}
