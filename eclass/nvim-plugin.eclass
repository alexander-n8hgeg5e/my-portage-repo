...
nvim-plugin_pkg_postinst() {
	update_nvim_helptags		# from vim-doc
...
# This function calls the update_nvim_helptags and update_vim_afterscripts
# functions and eventually removes a bunch of empty directories.
nvim-plugin_pkg_postrm() {
